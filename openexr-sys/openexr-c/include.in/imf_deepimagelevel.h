...
typedef struct Imf_3_0__DeepImageLevel_t_s {
    char _unused;
} OPENEXR_CPPMM_ALIGN(8) Imf_3_0__DeepImageLevel_t;
typedef Imf_3_0__DeepImageLevel_t Imf_DeepImageLevel_t;

typedef struct Imf_3_0__DeepImageLevel__Iterator_t_s {
    char data[%SIZEImf_3_0::DeepImageLevel::Iterator%];
} OPENEXR_CPPMM_ALIGN(%ALIGNImf_3_0::DeepImageLevel::Iterator%) Imf_3_0__DeepImageLevel__Iterator_t;
...
typedef struct Imf_3_0__DeepImageLevel__ConstIterator_t_s {
    char data[%SIZEImf_3_0::DeepImageLevel::ConstIterator%];
} OPENEXR_CPPMM_ALIGN(%ALIGNImf_3_0::DeepImageLevel::ConstIterator%) Imf_3_0__DeepImageLevel__ConstIterator_t;
