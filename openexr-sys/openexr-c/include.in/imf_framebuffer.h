...
typedef struct Imf_3_0__Slice_t_s {
    char data[%SIZEImf_3_0::Slice%];
} OPENEXR_CPPMM_ALIGN(%ALIGNImf_3_0::Slice%) Imf_3_0__Slice_t;
...
typedef struct Imf_3_0__FrameBuffer__Iterator_t_s {
    char data[%SIZEImf_3_0::FrameBuffer::Iterator%];
} OPENEXR_CPPMM_ALIGN(%ALIGNImf_3_0::FrameBuffer::Iterator%) Imf_3_0__FrameBuffer__Iterator_t;
...
typedef struct Imf_3_0__FrameBuffer__ConstIterator_t_s {
    char data[%SIZEImf_3_0::FrameBuffer::ConstIterator%];
} OPENEXR_CPPMM_ALIGN(%ALIGNImf_3_0::FrameBuffer::ConstIterator%) Imf_3_0__FrameBuffer__ConstIterator_t;
