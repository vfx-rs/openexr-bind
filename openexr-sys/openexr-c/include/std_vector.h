...
OPENEXR_API unsigned int std__vector_float__data(
    std_vector_float_t * this_
    , float * * return_);
#define std_vector_float_data std__vector_float__data


OPENEXR_API unsigned int std__vector_float__data_const(
    std_vector_float_t const * this_
    , float const * * return_);
#define std_vector_float_data_const std__vector_float__data_const


OPENEXR_API unsigned int std__vector_float__push_back(
    std_vector_float_t * this_
    , float const * value);
