...
OPENEXR_API unsigned int Imf_3_0__Image_levelWidth(
    Imf_Image_t const * this_
    , int * return_
    , int lx);
...
OPENEXR_API unsigned int Imf_3_0__Image_levelHeight(
    Imf_Image_t const * this_
    , int * return_
    , int ly);
...
OPENEXR_API unsigned int Imf_3_0__Image_resize(
    Imf_Image_t * this_
    , Imath_Box2i_t const * dataWindow);
#define Imf_Image_resize Imf_3_0__Image_resize


OPENEXR_API unsigned int Imf_3_0__Image_resize_1(
    Imf_Image_t * this_
    , Imath_Box2i_t const * dataWindow
...
OPENEXR_API unsigned int Imf_3_0__Image_shiftPixels(
    Imf_Image_t * this_
    , int dx
    , int dy);
...
OPENEXR_API unsigned int Imf_3_0__Image_insertChannel(
    Imf_Image_t * this_
...
OPENEXR_API unsigned int Imf_3_0__Image_insertChannel_1(
    Imf_Image_t * this_
    , std_string_t const * name
...
OPENEXR_API unsigned int Imf_3_0__Image_eraseChannel(
    Imf_Image_t * this_
    , std_string_t const * name);
#define Imf_Image_eraseChannel Imf_3_0__Image_eraseChannel


OPENEXR_API unsigned int Imf_3_0__Image_clearChannels(
    Imf_Image_t * this_);
#define Imf_Image_clearChannels Imf_3_0__Image_clearChannels


OPENEXR_API unsigned int Imf_3_0__Image_renameChannel(
    Imf_Image_t * this_
...
OPENEXR_API unsigned int Imf_3_0__Image_level_const(
    Imf_Image_t const * this_
