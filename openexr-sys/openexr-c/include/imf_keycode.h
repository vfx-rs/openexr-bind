...
typedef struct Imf_3_0__KeyCode_t_s {
    char data[28];
} OPENEXR_ALIGN(4) Imf_3_0__KeyCode_t;
typedef Imf_3_0__KeyCode_t Imf_KeyCode_t;


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__KeyCode_sizeof();
#define Imf_KeyCode_sizeof Imf_3_0__KeyCode_sizeof


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__KeyCode_alignof();
#define Imf_KeyCode_alignof Imf_3_0__KeyCode_alignof


OPENEXR_API unsigned int Imf_3_0__KeyCode_ctor(
    Imf_KeyCode_t * this_
    , int filmMfcCode
    , int filmType
    , int prefix
...
OPENEXR_API unsigned int Imf_3_0__KeyCode_copy(
    Imf_KeyCode_t * this_
    , Imf_KeyCode_t const * other);
#define Imf_KeyCode_copy Imf_3_0__KeyCode_copy


OPENEXR_API unsigned int Imf_3_0__KeyCode_dtor(
    Imf_KeyCode_t * this_);
#define Imf_KeyCode_dtor Imf_3_0__KeyCode_dtor


OPENEXR_API unsigned int Imf_3_0__KeyCode__assign(
    Imf_KeyCode_t * this_
