...
typedef struct Imf_3_0__FrameBuffer__ConstIterator_t_s {
    char data[8];
} OPENEXR_ALIGN(8) Imf_3_0__FrameBuffer__ConstIterator_t;
typedef Imf_3_0__FrameBuffer__ConstIterator_t Imf_FrameBuffer_ConstIterator_t;


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__Slice_sizeof();
#define Imf_Slice_sizeof Imf_3_0__Slice_sizeof


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__Slice_alignof();
#define Imf_Slice_alignof Imf_3_0__Slice_alignof


OPENEXR_API unsigned int Imf_3_0__Slice_ctor(
    Imf_Slice_t * this_
    , Imf_PixelType type
    , char * base
...
OPENEXR_API unsigned int Imf_3_0__Slice_with_origin(
    Imf_Slice_t * return_
    , Imf_PixelType type
    , void const * ptr
...
OPENEXR_API unsigned int Imf_3_0__Slice_with_window(
    Imf_Slice_t * return_
    , Imf_PixelType type
    , void const * ptr
...
OPENEXR_API unsigned int Imf_3_0__Slice_dtor(
    Imf_Slice_t * this_);
#define Imf_Slice_dtor Imf_3_0__Slice_dtor


OPENEXR_API unsigned int Imf_3_0__Slice_copy(
    Imf_Slice_t * this_
    , Imf_Slice_t const * rhs);
#define Imf_Slice_copy Imf_3_0__Slice_copy


OPENEXR_API unsigned int Imf_3_0__FrameBuffer_insert(
...
OPENEXR_API unsigned int Imf_3_0__FrameBuffer_findSlice(
    Imf_FrameBuffer_t * this_
    , Imf_Slice_t * * return_
    , char const * name);
...
OPENEXR_API unsigned int Imf_3_0__FrameBuffer_findSlice_const(
...
OPENEXR_API unsigned int Imf_3_0__FrameBuffer_find_1(
    Imf_FrameBuffer_t const * this_
    , Imf_FrameBuffer_ConstIterator_t * return_
    , char const * name);
...
OPENEXR_API unsigned int Imf_3_0__FrameBuffer__ConstIterator_slice(
    Imf_FrameBuffer_ConstIterator_t const * this_
    , Imf_Slice_t const * * return_);
#define Imf_FrameBuffer_ConstIterator_slice Imf_3_0__FrameBuffer__ConstIterator_slice


OPENEXR_API unsigned int Imf_3_0__FrameBuffer__ConstIterator_copy(
    Imf_FrameBuffer_ConstIterator_t * this_
...
OPENEXR_API unsigned int Imf_3_0_frame_buffer_const_iter_eq(
    _Bool * return_
