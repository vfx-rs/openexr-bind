...
typedef struct Imf_3_0__OutputPart_t_s {
    char data[8];
} OPENEXR_ALIGN(8) Imf_3_0__OutputPart_t;
typedef Imf_3_0__OutputPart_t Imf_OutputPart_t;


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__OutputPart_sizeof();
#define Imf_OutputPart_sizeof Imf_3_0__OutputPart_sizeof


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__OutputPart_alignof();
#define Imf_OutputPart_alignof Imf_3_0__OutputPart_alignof


OPENEXR_API unsigned int Imf_3_0__OutputPart_ctor(
