...
OPENEXR_API unsigned int std__set_std__string___const_iterator_sizeof();
#define std_set_string_iterator_sizeof std__set_std__string___const_iterator_sizeof


/** returns the size of this type in bytes */
OPENEXR_API unsigned int std__set_std__string___const_iterator_alignof();
#define std_set_string_iterator_alignof std__set_std__string___const_iterator_alignof


OPENEXR_API unsigned int std__set_std__string___const_iterator_deref(
...
OPENEXR_API unsigned int std__set_std__string___const_iterator_inc(
    std_set_string_iterator_t * this_
    , std_set_string_iterator_t * * return_);
#define std_set_string_iterator_inc std__set_std__string___const_iterator_inc


OPENEXR_API unsigned int std_set_string_const_iterator_eq(
    _Bool * return_
