...
OPENEXR_API unsigned int Imf_3_0_halfToUint(
    unsigned int * return_
    , Imath_half_t h);
#define Imf_halfToUint Imf_3_0_halfToUint


OPENEXR_API unsigned int Imf_3_0_floatToUint(
    unsigned int * return_
    , float f);
#define Imf_floatToUint Imf_3_0_floatToUint


OPENEXR_API unsigned int Imf_3_0_uintToHalf(
    Imath_half_t * return_
    , unsigned int ui);
#define Imf_uintToHalf Imf_3_0_uintToHalf


OPENEXR_API unsigned int Imf_3_0_floatToHalf(
    Imath_half_t * return_
    , float f);
