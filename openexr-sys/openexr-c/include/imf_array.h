...
OPENEXR_API unsigned int Imf_3_0__Array2D_float__delete(
    Imf_Array2DFloat_t * this_);
#define Imf_Array2DFloat_delete Imf_3_0__Array2D_float__delete


OPENEXR_API unsigned int Imf_3_0__Array2D_float__row(
    Imf_Array2DFloat_t * this_
    , float * * return_
    , long x);
...
OPENEXR_API unsigned int Imf_3_0__Array2D_float__const_row(
...
OPENEXR_API unsigned int Imf_3_0__Array2D_float__resizeErase(
    Imf_Array2DFloat_t * this_
    , long sizeX
    , long sizeY);
...
OPENEXR_API unsigned int Imf_3_0__Array2D_float__resizeEraseUnsafe(
    Imf_Array2DFloat_t * this_
    , long sizeX
    , long sizeY);
...
OPENEXR_API unsigned int Imf_3_0__Array2D_float__height(
    Imf_Array2DFloat_t const * this_
    , long * return_);
#define Imf_Array2DFloat_height Imf_3_0__Array2D_float__height


OPENEXR_API unsigned int Imf_3_0__Array2D_float__width(
    Imf_Array2DFloat_t const * this_
    , long * return_);
