...
typedef struct Imf_3_0__DeepScanLineOutputFile_t_s {
    char _unused;
} OPENEXR_ALIGN(8) Imf_3_0__DeepScanLineOutputFile_t;
typedef Imf_3_0__DeepScanLineOutputFile_t Imf_DeepScanLineOutputFile_t;


OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputFile_ctor(
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputFile_dtor(
    Imf_DeepScanLineOutputFile_t * this_);
#define Imf_DeepScanLineOutputFile_dtor Imf_3_0__DeepScanLineOutputFile_dtor


OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputFile_fileName(
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputFile_header(
    Imf_DeepScanLineOutputFile_t const * this_
    , Imf_Header_t const * * return_);
#define Imf_DeepScanLineOutputFile_header Imf_3_0__DeepScanLineOutputFile_header


OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputFile_setFrameBuffer(
    Imf_DeepScanLineOutputFile_t * this_
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputFile_frameBuffer(
    Imf_DeepScanLineOutputFile_t const * this_
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputFile_writePixels(
    Imf_DeepScanLineOutputFile_t * this_
    , int numScanLines);
#define Imf_DeepScanLineOutputFile_writePixels Imf_3_0__DeepScanLineOutputFile_writePixels


OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputFile_currentScanLine(
    Imf_DeepScanLineOutputFile_t const * this_
    , int * return_);
#define Imf_DeepScanLineOutputFile_currentScanLine Imf_3_0__DeepScanLineOutputFile_currentScanLine


OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputFile_copyPixels_from_file(
    Imf_DeepScanLineOutputFile_t * this_
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputFile_copyPixels_from_part(
    Imf_DeepScanLineOutputFile_t * this_
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputFile_updatePreviewImage(
    Imf_DeepScanLineOutputFile_t * this_
