...
typedef struct Imf_3_0__DeepImageLevel_t_s {
    char _unused;
} __attribute__((aligned(8))) Imf_3_0__DeepImageLevel_t;
typedef Imf_3_0__DeepImageLevel_t Imf_DeepImageLevel_t;

typedef struct Imf_3_0__DeepImageLevel__Iterator_t_s {
    char data[8];
} __attribute__((aligned(8))) Imf_3_0__DeepImageLevel__Iterator_t;
...
typedef struct Imf_3_0__DeepImageLevel__ConstIterator_t_s {
    char data[8];
} __attribute__((aligned(8))) Imf_3_0__DeepImageLevel__ConstIterator_t;
