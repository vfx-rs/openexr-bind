...
pub fn std__vector_std__string__size(this_: *const std_vector_string_t, return_: *mut c_ulong) -> Exception;

pub fn std__vector_std__string__index(this_: *const std_vector_string_t, return_: *mut *const std_string_t, pos: c_ulong) -> Exception;
...
pub fn std__vector_float__size(this_: *const std_vector_float_t, return_: *mut c_ulong) -> Exception;

pub fn std__vector_float__index(this_: *const std_vector_float_t, return_: *mut *const c_float, pos: c_ulong) -> Exception;
