...
#[repr(C, align(%ALIGNImf_3_0::DeepScanLineOutputPart%))]
#[derive(Clone)]
pub struct Imf_3_0__DeepScanLineOutputPart_t {
    _inner: [u8; %SIZEImf_3_0::DeepScanLineOutputPart%]
}

impl Default for Imf_3_0__DeepScanLineOutputPart_t {
    fn default() -> Self {
        Self { _inner: [0u8; %SIZEImf_3_0::DeepScanLineOutputPart%] }
    }
}
