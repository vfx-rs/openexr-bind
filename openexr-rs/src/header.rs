...
#[repr(transparent)]
pub struct Header(sys::Imf_Header_t);

impl Header {
    /// Construct a new [`Header`] with the given attributes.
    ///
    /// # Arguments
    /// * `data_window` - The window which contains data. Typically will be
    /// [[0, width-1], [0, height-1]].
    /// * `display_window` - The window which represents the viewable portion
    /// of the image. Typically will be [[0, width-1], [0, height-1]], but may be smaller than the data window to represent overscan, or larger to represent a crop.
    ...
    /// * `line_order` - The vertical order in which scanlines are stored. This is a hint for readers and may not be respected.
    ...
    where
        ...
        V: Vec2<f32>,
    {
        let mut header = sys::Imf_Header_t::default();
        unsafe {
            sys::Imf_Header_ctor(
                &mut header,
    ...
    pub fn reads_nothing(&mut self) -> bool {
        unsafe { sys::Imf_Header_readsNothing(&mut self.0) }
    }
}
...
impl Header {
    ...
    {
        unsafe {
            let ptr = sys::Imf_Header_displayWindow(&mut self.0);
    ...
    {
        unsafe {
            let ptr = sys::Imf_Header_dataWindow(&mut self.0);
            &mut *(ptr as *mut sys::Imath_Box2i_t as *mut B)
        }
    }
    ...
    pub fn set_pixel_aspect_ratio(&mut self, par: f32) {
        unsafe {
            *sys::Imf_Header_pixelAspectRatio(&mut self.0) = par;
        }
    }
    ...
    {
        unsafe {
            let ptr = sys::Imf_Header_screenWindowCenter(&mut self.0);
            &mut *(ptr as *mut sys::Imath_Box2i_t as *mut B)
        }
    }
    ...
    pub fn screen_window_width_mut(&mut self) -> &f32 {
        unsafe {
            let ptr = sys::Imf_Header_screenWindowWidth(&mut self.0);
            &mut *ptr
        }
    }
    ...
    pub fn channels_mut(&mut self) -> &mut ChannelList {
        unsafe {
            let ptr = sys::Imf_Header_channels(&mut self.0);
    ...
    pub fn set_line_order(&mut self, lo: LineOrder) {
        unsafe {
            *sys::Imf_Header_lineOrder(&mut self.0) = lo.into();
        }
    }
    ...
    pub fn set_compression(&mut self, cmp: Compression) {
        unsafe {
            *sys::Imf_Header_compression(&mut self.0) = cmp.into();
        }
    }
}
...
impl Header {
    ...
    pub fn set_name(&mut self, name: &str) {
        unsafe {
            ...
            sys::Imf_Header_setName(&mut self.0, s);
    ...
    pub fn set_image_type(&mut self, image_type: &str) {
        unsafe {
            ...
            sys::Imf_Header_setType(&mut self.0, s);
            sys::std___cxx11_string_dtor(s);
        }
    }
    ...
    pub fn set_version(&mut self, v: i32) {
        unsafe {
            sys::Imf_Header_setVersion(&mut self.0, v);
        }
    }
...
impl Header {
    ...
    pub fn set_view(&mut self, view: &str) {
        unsafe {
            ...
            sys::Imf_Header_setView(&mut self.0, s);
            sys::std___cxx11_string_dtor(s);
        }
    }
...
impl Header {
    ...
    pub fn set_tile_description(&mut self, td: &TileDescription) {
        unsafe {
            sys::Imf_Header_setTileDescription(&mut self.0, td);
        }
    }
...
impl Header {
    ...
    pub fn set_preview_image(&mut self, pi: &PreviewImage) {
        unsafe {
            sys::Imf_Header_setPreviewImage(&mut self.0, &pi.0);
        }
    }
...
impl Header {
    ...
    pub fn erase(&mut self, name: &str) {
        let c_name = CString::new(name).expect("Invalid UTF-8 in name");
        unsafe {
            sys::Imf_Header_erase(&mut self.0, c_name.as_ptr());
        }
    }
...
impl Drop for Header {
    fn drop(&mut self) {
        unsafe {
            sys::Imf_Header_dtor(&mut self.0);
        }
    }
}
