...
typedef struct Imf_3_0__DeepScanLineInputPart_t_s {
    char data[8];
} OPENEXR_ALIGN(8) Imf_3_0__DeepScanLineInputPart_t;
typedef Imf_3_0__DeepScanLineInputPart_t Imf_DeepScanLineInputPart_t;


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__DeepScanLineInputPart_sizeof();
#define Imf_DeepScanLineInputPart_sizeof Imf_3_0__DeepScanLineInputPart_sizeof


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__DeepScanLineInputPart_alignof();
#define Imf_DeepScanLineInputPart_alignof Imf_3_0__DeepScanLineInputPart_alignof


OPENEXR_API unsigned int Imf_3_0__DeepScanLineInputPart_ctor(
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineInputPart_frameBuffer(
    Imf_DeepScanLineInputPart_t const * this_
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineInputPart_isComplete(
    Imf_DeepScanLineInputPart_t const * this_
    , _Bool * return_);
#define Imf_DeepScanLineInputPart_isComplete Imf_3_0__DeepScanLineInputPart_isComplete


OPENEXR_API unsigned int Imf_3_0__DeepScanLineInputPart_readPixels(
    Imf_DeepScanLineInputPart_t * this_
    , int scanLine1
    , int scanLine2);
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineInputPart_readPixels_from_frame_buffer(
    Imf_DeepScanLineInputPart_t const * this_
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineInputPart_rawPixelData(
    Imf_DeepScanLineInputPart_t * this_
    , int firstScanLine
    , char * pixelData
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineInputPart_readPixelSampleCounts(
    Imf_DeepScanLineInputPart_t * this_
    , int scanline1
    , int scanline2);
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineInputPart_readPixelSampleCounts_into_frame_buffer(
    Imf_DeepScanLineInputPart_t const * this_
    , char const * rawdata
    , Imf_DeepFrameBuffer_t const * frameBuffer
    , int scanLine1
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineInputPart_firstScanLineInChunk(
    Imf_DeepScanLineInputPart_t const * this_
    , int * return_
    , int y);
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineInputPart_lastScanLineInChunk(
    Imf_DeepScanLineInputPart_t const * this_
    , int * return_
    , int y);
