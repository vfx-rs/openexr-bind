...
OPENEXR_API unsigned int Imf_3_0__SampleCountChannel_index(
    Imf_SampleCountChannel_t const * this_
...
OPENEXR_API unsigned int Imf_3_0__SampleCountChannel_at(
    Imf_SampleCountChannel_t const * this_
    , unsigned int const * * return_
    , int x
    , int y);
...
OPENEXR_API unsigned int Imf_3_0__SampleCountChannel_row(
    Imf_SampleCountChannel_t const * this_
    , unsigned int const * * return_
    , int r);
...
OPENEXR_API unsigned int Imf_3_0__SampleCountChannel_set(
    Imf_SampleCountChannel_t * this_
    , int x
    , int y
...
OPENEXR_API unsigned int Imf_3_0__SampleCountChannel_set_row(
    Imf_SampleCountChannel_t * this_
    , int r
    , unsigned int * newNumSamples);
...
OPENEXR_API unsigned int Imf_3_0__SampleCountChannel_sampleBufferSize(
    Imf_SampleCountChannel_t const * this_
    , unsigned long * return_);
#define Imf_SampleCountChannel_sampleBufferSize Imf_3_0__SampleCountChannel_sampleBufferSize


OPENEXR_API unsigned int Imf_3_0__SampleCountChannel__Edit_ctor(
...
OPENEXR_API unsigned int Imf_3_0__SampleCountChannel__Edit_dtor(
    Imf_SampleCountChannel_Edit_t * this_);
#define Imf_SampleCountChannel_Edit_dtor Imf_3_0__SampleCountChannel__Edit_dtor


OPENEXR_API unsigned int Imf_3_0__SampleCountChannel__Edit_sampleCounts(
