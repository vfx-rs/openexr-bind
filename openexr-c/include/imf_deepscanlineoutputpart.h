...
typedef struct Imf_3_0__DeepScanLineOutputPart_t_s {
    char data[8];
} OPENEXR_ALIGN(8) Imf_3_0__DeepScanLineOutputPart_t;
typedef Imf_3_0__DeepScanLineOutputPart_t Imf_DeepScanLineOutputPart_t;


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputPart_sizeof();
#define Imf_DeepScanLineOutputPart_sizeof Imf_3_0__DeepScanLineOutputPart_sizeof


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputPart_alignof();
#define Imf_DeepScanLineOutputPart_alignof Imf_3_0__DeepScanLineOutputPart_alignof


OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputPart_ctor(
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputPart_fileName(
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputPart_header(
    Imf_DeepScanLineOutputPart_t const * this_
    , Imf_Header_t const * * return_);
#define Imf_DeepScanLineOutputPart_header Imf_3_0__DeepScanLineOutputPart_header


OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputPart_setFrameBuffer(
    Imf_DeepScanLineOutputPart_t * this_
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputPart_frameBuffer(
    Imf_DeepScanLineOutputPart_t const * this_
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputPart_writePixels(
    Imf_DeepScanLineOutputPart_t * this_
    , int numScanLines);
#define Imf_DeepScanLineOutputPart_writePixels Imf_3_0__DeepScanLineOutputPart_writePixels


OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputPart_currentScanLine(
    Imf_DeepScanLineOutputPart_t const * this_
    , int * return_);
#define Imf_DeepScanLineOutputPart_currentScanLine Imf_3_0__DeepScanLineOutputPart_currentScanLine


OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputPart_copyPixels_from_file(
    Imf_DeepScanLineOutputPart_t * this_
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputPart_copyPixels_from_part(
    Imf_DeepScanLineOutputPart_t * this_
...
OPENEXR_API unsigned int Imf_3_0__DeepScanLineOutputPart_updatePreviewImage(
    Imf_DeepScanLineOutputPart_t * this_
