...
typedef struct Imf_3_0__TiledInputPart_t_s {
    char data[8];
} OPENEXR_ALIGN(8) Imf_3_0__TiledInputPart_t;
typedef Imf_3_0__TiledInputPart_t Imf_TiledInputPart_t;


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__TiledInputPart_sizeof();
#define Imf_TiledInputPart_sizeof Imf_3_0__TiledInputPart_sizeof


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__TiledInputPart_alignof();
#define Imf_TiledInputPart_alignof Imf_3_0__TiledInputPart_alignof


OPENEXR_API unsigned int Imf_3_0__TiledInputPart_ctor(
...
OPENEXR_API unsigned int Imf_3_0__TiledInputPart_levelWidth(
    Imf_TiledInputPart_t const * this_
    , int * return_
    , int lx);
...
OPENEXR_API unsigned int Imf_3_0__TiledInputPart_levelHeight(
    Imf_TiledInputPart_t const * this_
    , int * return_
    , int ly);
...
OPENEXR_API unsigned int Imf_3_0__TiledInputPart_numXTiles(
    Imf_TiledInputPart_t const * this_
    , int * return_
    , int lx);
...
OPENEXR_API unsigned int Imf_3_0__TiledInputPart_numYTiles(
    Imf_TiledInputPart_t const * this_
    , int * return_
    , int ly);
...
OPENEXR_API unsigned int Imf_3_0__TiledInputPart_dataWindowForLevel(
    Imf_TiledInputPart_t const * this_
...
OPENEXR_API unsigned int Imf_3_0__TiledInputPart_dataWindowForTile(
    Imf_TiledInputPart_t const * this_
    , Imath_Box2i_t * return_
    , int dx
    , int dy
...
OPENEXR_API unsigned int Imf_3_0__TiledInputPart_readTile(
    Imf_TiledInputPart_t * this_
    , int dx
    , int dy
    , int lx
...
OPENEXR_API unsigned int Imf_3_0__TiledInputPart_readTiles(
    Imf_TiledInputPart_t * this_
    , int dx1
    , int dx2
    , int dy1
...
OPENEXR_API unsigned int Imf_3_0__TiledInputPart_rawTileData(
    Imf_TiledInputPart_t * this_
    , int * dx
    , int * dy
    , int * lx
