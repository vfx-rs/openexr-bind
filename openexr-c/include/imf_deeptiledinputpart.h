...
typedef struct Imf_3_0__DeepTiledInputPart_t_s {
    char data[8];
} OPENEXR_ALIGN(8) Imf_3_0__DeepTiledInputPart_t;
typedef Imf_3_0__DeepTiledInputPart_t Imf_DeepTiledInputPart_t;


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_sizeof();
#define Imf_DeepTiledInputPart_sizeof Imf_3_0__DeepTiledInputPart_sizeof


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_alignof();
#define Imf_DeepTiledInputPart_alignof Imf_3_0__DeepTiledInputPart_alignof


OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_ctor(
...
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_numLevels(
    Imf_DeepTiledInputPart_t const * this_
    , int * return_);
#define Imf_DeepTiledInputPart_numLevels Imf_3_0__DeepTiledInputPart_numLevels


OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_numXLevels(
    Imf_DeepTiledInputPart_t const * this_
    , int * return_);
#define Imf_DeepTiledInputPart_numXLevels Imf_3_0__DeepTiledInputPart_numXLevels


OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_numYLevels(
    Imf_DeepTiledInputPart_t const * this_
    , int * return_);
#define Imf_DeepTiledInputPart_numYLevels Imf_3_0__DeepTiledInputPart_numYLevels


OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_isValidLevel(
    Imf_DeepTiledInputPart_t const * this_
    , _Bool * return_
    , int lx
    , int ly);
...
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_levelWidth(
    Imf_DeepTiledInputPart_t const * this_
    , int * return_
    , int lx);
...
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_levelHeight(
    Imf_DeepTiledInputPart_t const * this_
    , int * return_
    , int ly);
...
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_numXTiles(
    Imf_DeepTiledInputPart_t const * this_
    , int * return_
    , int lx);
...
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_numYTiles(
    Imf_DeepTiledInputPart_t const * this_
    , int * return_
    , int ly);
...
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_dataWindowForLevel(
    Imf_DeepTiledInputPart_t const * this_
...
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_dataWindowForTile(
    Imf_DeepTiledInputPart_t const * this_
    , Imath_Box2i_t * return_
    , int dx
    , int dy
...
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_readTile(
    Imf_DeepTiledInputPart_t * this_
    , int dx
    , int dy
    , int lx
...
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_readTiles(
    Imf_DeepTiledInputPart_t * this_
    , int dx1
    , int dx2
    , int dy1
...
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_rawTileData(
    Imf_DeepTiledInputPart_t const * this_
    , int * dx
    , int * dy
    , int * lx
...
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_readPixelSampleCount(
    Imf_DeepTiledInputPart_t * this_
    , int dx
    , int dy
    , int lx
...
OPENEXR_API unsigned int Imf_3_0__DeepTiledInputPart_readPixelSampleCounts(
    Imf_DeepTiledInputPart_t * this_
    , int dx1
    , int dx2
    , int dy1
