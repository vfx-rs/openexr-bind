...
typedef struct Imf_3_0__ChannelList__ConstIterator_t_s {
    char data[8];
} OPENEXR_ALIGN(8) Imf_3_0__ChannelList__ConstIterator_t;
typedef Imf_3_0__ChannelList__ConstIterator_t Imf_ChannelList_ConstIterator_t;


OPENEXR_API unsigned int Imf_3_0__Channel_ctor(
    Imf_Channel_t * this_
    , Imf_PixelType type
    , int xSampling
    , int ySampling
...
OPENEXR_API unsigned int Imf_3_0__Channel__eq(
...
OPENEXR_API unsigned int Imf_3_0__Channel_dtor(
    Imf_Channel_t * this_);
#define Imf_Channel_dtor Imf_3_0__Channel_dtor


OPENEXR_API unsigned int Imf_3_0__Channel_copy(
    Imf_Channel_t * this_
    , Imf_Channel_t const * rhs);
#define Imf_Channel_copy Imf_3_0__Channel_copy


OPENEXR_API unsigned int Imf_3_0__Channel_move(
    Imf_Channel_t * this_
    , Imf_Channel_t * rhs);
#define Imf_Channel_move Imf_3_0__Channel_move


OPENEXR_API unsigned int Imf_3_0__ChannelList_insert(
...
OPENEXR_API unsigned int Imf_3_0__ChannelList_findChannel(
    Imf_ChannelList_t * this_
...
OPENEXR_API unsigned int Imf_3_0__ChannelList_findChannel_const(
...
OPENEXR_API unsigned int Imf_3_0__ChannelList_find_const(
    Imf_ChannelList_t const * this_
    , Imf_ChannelList_ConstIterator_t * return_
    , char const * name);
...
OPENEXR_API unsigned int Imf_3_0__ChannelList_layers(
    Imf_ChannelList_t const * this_
    , std_set_string_t * layerNames);
#define Imf_ChannelList_layers Imf_3_0__ChannelList_layers


OPENEXR_API unsigned int Imf_3_0__ChannelList_channelsInLayer(
    Imf_ChannelList_t * this_
...
OPENEXR_API unsigned int Imf_3_0__ChannelList_channelsInLayer_const(
    Imf_ChannelList_t const * this_
    , std_string_t const * layerName
...
OPENEXR_API unsigned int Imf_3_0__ChannelList_channelsWithPrefix(
    Imf_ChannelList_t * this_
    , char const * prefix
    , Imf_ChannelList_Iterator_t * first
    , Imf_ChannelList_Iterator_t * last);
...
OPENEXR_API unsigned int Imf_3_0__ChannelList_channelsWithPrefix_const(
    Imf_ChannelList_t const * this_
    , char const * prefix
    , Imf_ChannelList_ConstIterator_t * first
    , Imf_ChannelList_ConstIterator_t * last);
...
OPENEXR_API unsigned int Imf_3_0__ChannelList__eq(
    Imf_ChannelList_t const * this_
    , _Bool * return_
...
OPENEXR_API unsigned int Imf_3_0__ChannelList__ConstIterator_channel(
    Imf_ChannelList_ConstIterator_t const * this_
    , Imf_Channel_t const * * return_);
#define Imf_ChannelList_ConstIterator_channel Imf_3_0__ChannelList__ConstIterator_channel


OPENEXR_API unsigned int Imf_3_0__ChannelList__ConstIterator_copy(
    Imf_ChannelList_ConstIterator_t * this_
...
OPENEXR_API unsigned int Imf_3_0__ChannelList__ConstIterator_move(
    Imf_ChannelList_ConstIterator_t * this_
    , Imf_ChannelList_ConstIterator_t * rhs);
#define Imf_ChannelList_ConstIterator_move Imf_3_0__ChannelList__ConstIterator_move


OPENEXR_API unsigned int Imf_3_0_channel_list_const_iter_eq(
    _Bool * return_
