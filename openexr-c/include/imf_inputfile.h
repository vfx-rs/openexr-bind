...
OPENEXR_API unsigned int Imf_3_0__InputFile_from_stream(
    Imf_InputFile_t * * this_
    , Imf_IStream_t * is
    , int numThreads);
...
OPENEXR_API unsigned int Imf_3_0__InputFile_rawPixelData(
    Imf_InputFile_t * this_
    , int firstScanLine
...
OPENEXR_API unsigned int Imf_3_0__InputFile_rawPixelDataToBuffer(
    Imf_InputFile_t const * this_
    , int scanLine
    , char * pixelData
    , int * pixelDataSize);
...
OPENEXR_API unsigned int Imf_3_0__InputFile_rawTileData(
    Imf_InputFile_t * this_
    , int * dx
    , int * dy
    , int * lx
...
OPENEXR_API unsigned int Imf_3_0__GenericInputFile_dtor(
    Imf_GenericInputFile_t * this_);
#define Imf_GenericInputFile_dtor Imf_3_0__GenericInputFile_dtor


OPENEXR_API unsigned int Imf_3_0__GenericInputFile__assign(
    Imf_GenericInputFile_t * this_
...
OPENEXR_API unsigned int Imf_3_0__GenericInputFile_copy(
    Imf_GenericInputFile_t * * this_
    , Imf_GenericInputFile_t const * rhs);
