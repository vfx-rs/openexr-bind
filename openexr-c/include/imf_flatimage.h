...
OPENEXR_API unsigned int Imf_3_0__FlatImage_levelWidth(
    Imf_FlatImage_t const * this_
    , int * return_
    , int lx);
...
OPENEXR_API unsigned int Imf_3_0__FlatImage_levelHeight(
    Imf_FlatImage_t const * this_
    , int * return_
    , int ly);
...
OPENEXR_API unsigned int Imf_3_0__FlatImage_resize(
...
OPENEXR_API unsigned int Imf_3_0__FlatImage_shiftPixels(
    Imf_FlatImage_t * this_
    , int dx
    , int dy);
...
OPENEXR_API unsigned int Imf_3_0__FlatImage_insertChannel(
    Imf_FlatImage_t * this_
...
OPENEXR_API unsigned int Imf_3_0__FlatImage_eraseChannel(
    Imf_FlatImage_t * this_
    , std_string_t const * name);
#define Imf_FlatImage_eraseChannel Imf_3_0__FlatImage_eraseChannel


OPENEXR_API unsigned int Imf_3_0__FlatImage_clearChannels(
    Imf_FlatImage_t * this_);
#define Imf_FlatImage_clearChannels Imf_3_0__FlatImage_clearChannels


OPENEXR_API unsigned int Imf_3_0__FlatImage_renameChannel(
    Imf_FlatImage_t * this_
...
OPENEXR_API unsigned int Imf_3_0__FlatImage_default(
    Imf_FlatImage_t * * this_);
#define Imf_FlatImage_default Imf_3_0__FlatImage_default


OPENEXR_API unsigned int Imf_3_0__FlatImage_ctor(
    Imf_FlatImage_t * * this_
    , Imath_Box2i_t const * dataWindow
    , Imf_LevelMode levelMode
    , Imf_LevelRoundingMode levelRoundingMode);
...
OPENEXR_API unsigned int Imf_3_0__FlatImage_dtor(
    Imf_FlatImage_t * this_);
#define Imf_FlatImage_dtor Imf_3_0__FlatImage_dtor


OPENEXR_API unsigned int Imf_3_0__FlatImage_level(
    Imf_FlatImage_t * this_
...
OPENEXR_API unsigned int Imf_3_0__FlatImage_level_const(
    Imf_FlatImage_t const * this_
