...
typedef struct Imf_3_0__Rational_t_s {
    int n;
    unsigned int d;
} OPENEXR_ALIGN(4) Imf_3_0__Rational_t;
typedef Imf_3_0__Rational_t Imf_Rational_t;


OPENEXR_API unsigned int Imf_3_0__Rational_default(
    Imf_Rational_t * this_);
#define Imf_Rational_default Imf_3_0__Rational_default


OPENEXR_API unsigned int Imf_3_0__Rational_ctor(
    Imf_Rational_t * this_
    , int n
    , int d);
...
OPENEXR_API unsigned int Imf_3_0__Rational_from_f64(
    Imf_Rational_t * this_
    , double x);
#define Imf_Rational_from_f64 Imf_3_0__Rational_from_f64


OPENEXR_API unsigned int Imf_3_0__Rational_as_f64(
