...
typedef struct Imf_3_0__FlatImageLevel_t_s {
    char _unused;
} __attribute__((aligned(8))) Imf_3_0__FlatImageLevel_t;
typedef Imf_3_0__FlatImageLevel_t Imf_FlatImageLevel_t;

typedef struct Imf_3_0__FlatImageLevel__Iterator_t_s {
    char data[8];
} __attribute__((aligned(8))) Imf_3_0__FlatImageLevel__Iterator_t;
...
typedef struct Imf_3_0__FlatImageLevel__ConstIterator_t_s {
    char data[8];
} __attribute__((aligned(8))) Imf_3_0__FlatImageLevel__ConstIterator_t;
