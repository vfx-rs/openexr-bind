...
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel_findChannel_const(
    Imf_FlatImageLevel_t const * this_
...
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel_channel(
    Imf_FlatImageLevel_t * this_
    , Imf_FlatImageChannel_t * * return_
    , std_string_t const * name);
...
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel_channel_const(
    Imf_FlatImageLevel_t const * this_
    , Imf_FlatImageChannel_t const * * return_
    , std_string_t const * name);
...
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel_findTypedChannel_half(
    Imf_FlatImageLevel_t * this_
...
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel_findTypedChannel_float(
    Imf_FlatImageLevel_t * this_
...
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel_findTypedChannel_uint(
    Imf_FlatImageLevel_t * this_
...
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel_findTypedChannel_half_const(
    Imf_FlatImageLevel_t const * this_
...
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel_findTypedChannel_float_const(
    Imf_FlatImageLevel_t const * this_
...
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel_findTypedChannel_uint_const(
    Imf_FlatImageLevel_t const * this_
...
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel__Iterator_channel(
    Imf_FlatImageLevel_Iterator_t const * this_
    , Imf_FlatImageChannel_t * * return_);
#define Imf_FlatImageLevel_Iterator_channel Imf_3_0__FlatImageLevel__Iterator_channel


OPENEXR_API unsigned int Imf_3_0__FlatImageLevel__Iterator_copy(
    Imf_FlatImageLevel_Iterator_t * this_
...
/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel__ConstIterator_sizeof();
#define Imf_FlatImageLevel_ConstIterator_sizeof Imf_3_0__FlatImageLevel__ConstIterator_sizeof


/** returns the size of this type in bytes */
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel__ConstIterator_alignof();
#define Imf_FlatImageLevel_ConstIterator_alignof Imf_3_0__FlatImageLevel__ConstIterator_alignof


OPENEXR_API unsigned int Imf_3_0__FlatImageLevel__ConstIterator_ctor(
...
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel__ConstIterator_from_mut(
    Imf_FlatImageLevel_ConstIterator_t * this_
    , Imf_FlatImageLevel_Iterator_t const * rhs);
#define Imf_FlatImageLevel_ConstIterator_from_mut Imf_3_0__FlatImageLevel__ConstIterator_from_mut


OPENEXR_API unsigned int Imf_3_0__FlatImageLevel__ConstIterator_inc(
    Imf_FlatImageLevel_ConstIterator_t * this_
    , Imf_FlatImageLevel_ConstIterator_t * * return_);
#define Imf_FlatImageLevel_ConstIterator_inc Imf_3_0__FlatImageLevel__ConstIterator_inc


OPENEXR_API unsigned int Imf_3_0__FlatImageLevel__ConstIterator_name(
...
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel__ConstIterator_channel(
    Imf_FlatImageLevel_ConstIterator_t const * this_
    , Imf_FlatImageChannel_t const * * return_);
#define Imf_FlatImageLevel_ConstIterator_channel Imf_3_0__FlatImageLevel__ConstIterator_channel


OPENEXR_API unsigned int Imf_3_0__FlatImageLevel__ConstIterator_copy(
    Imf_FlatImageLevel_ConstIterator_t * this_
...
OPENEXR_API unsigned int Imf_3_0__FlatImageLevel__ConstIterator_move(
    Imf_FlatImageLevel_ConstIterator_t * this_
