...
typedef struct Imf_3_0__Header_t_s {
    char data[%SIZEImf_3_0::Header%];
} OPENEXR_CPPMM_ALIGN(%ALIGNImf_3_0::Header%) Imf_3_0__Header_t;
typedef Imf_3_0__Header_t Imf_Header_t;

typedef struct Imf_3_0__Header__Iterator_t_s {
    char data[%SIZEImf_3_0::Header::Iterator%];
} OPENEXR_CPPMM_ALIGN(%ALIGNImf_3_0::Header::Iterator%) Imf_3_0__Header__Iterator_t;
typedef Imf_3_0__Header__Iterator_t Imf_Header_Iterator_t;

typedef struct Imf_3_0__Header__ConstIterator_t_s {
    char data[%SIZEImf_3_0::Header::ConstIterator%];
} OPENEXR_CPPMM_ALIGN(%ALIGNImf_3_0::Header::ConstIterator%) Imf_3_0__Header__ConstIterator_t;
